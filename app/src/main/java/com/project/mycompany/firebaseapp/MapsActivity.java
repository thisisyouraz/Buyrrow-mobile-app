...
//    private EditText txt_name, txt_cnic;
...
//            txt_name = findViewById(R.id.txtAdTitleRenter);
//            txt_cnic = findViewById(R.id.txtAdContactRenter);
...
//                txt_cnic.getText().toString(),
                location.getLongitude(),
                location.getLatitude()
        );

        FirebaseDatabase.getInstance().getReference("Current Location").child(adId)
    ...
    public void btnSubmit(View view) {
        ...
        Intent intent=new Intent(getApplicationContext(),CellRentDetail.class);
        intent.putExtra("adInfo",credentials);
        intent.putExtra("call from","MapActivity");
